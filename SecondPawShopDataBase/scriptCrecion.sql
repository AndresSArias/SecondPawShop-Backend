...
;
/*Creación de vistas*/
DROP VIEW IF EXISTS VISTAHISTORIAL;

CREATE VIEW VISTAHISTORIAL AS
SELECT P.IMAGEN, P.NOMBRE, P.CATEGORIA, P.DESCRIPCION, V.CANTIDADACOMPRAR, V.PRECIOTOTAL, V.IDUSUARIOCOMPRADOR
FROM PRODUCTO P, VENTA V
WHERE V.IDUSUARIOPROPETARIO = P.IDUSUARIOFK AND V.NOMBREPRODUCTO = P.NOMBRE
